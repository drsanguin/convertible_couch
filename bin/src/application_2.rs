...
use convertible_couch_lib::{
    ...
    speakers_settings::{
        CurrentSpeakersSettingsApiTrait2, SpeakerInfo, SpeakersSettings, SpeakersSettingsResult,
    },
    ApplicationError,
};
...
pub struct Application<
    ...
    TSpeakersSettingsApi: CurrentSpeakersSettingsApiTrait2,
...
mod tests {
    ...
    use crate::{
        application_2::map_to_log_level, commands::shared::log_level_option::LogLevelOption,
    };
